  ...
  return (
    ...
    <div className='buton'>
      ...
      >
        ...
        ALL CONTENT IS FOR INFORMATIONAL PURPOSES ONLY. THIS IS NOT MEDICAL ADVICE, SEEK ADVICE FROM A MEDICAL PROFESSIONAL REGARDING YOUR CONDITION AND POTENTIAL CURES.
